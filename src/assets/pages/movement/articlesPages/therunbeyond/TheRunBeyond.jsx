  ...
  return (
    <Wrapper>
      ...
      <section className="sec1">
        <h1 className="h1Sec1">The Run Beyond series: The power of running as therapy</h1>
        <p className="pSec1">
      ...
      <section className="secvideo">
        <video src={atmosheric} width="1400" loop muted autoPlay />
      </section>
      ...
      <section className="sectionText">
        <div className="containerSec3">
          ...
          <h4 className="containerSec3_h4">Lost – How Jimmy Watkins found himself</h4>
      ...
      <section className="IframeSection">
        <iframe src={`https://www.youtube.com/embed/21x92GkzaU4`} frameBorder={0} allowFullScreen allow="autoplay" />
      </section>

      <section className="sectionText">
        <div className="containerSec3">
          <h4 className="containerSec3_h4">Hope – Sydney Allen-Ash on what running can be</h4>

          <p className="pSec3_botton">
            “Can you describe the feeling?” Sydney Allen-Ash asks the runners she speaks to. Her ambition is to create a space to highlight and encourage the
            simplicity, accessibility and mental benefits of running.
            <br /> <br />
            “When I run, I become part of the whole universe,” one runner shares. “It saved me,” another reflects. In the town of Hope in Canada, Sydney looks
            beyond time pressure and the competitive nature of sport and encourages candid dialog around the joy of running and the impact it can have on our
            lives.
            <br /> <br />
          </p>
        </div>
      ...
      <section className="IframeSection">
        <iframe src={`https://www.youtube.com/embed/8tusqlgi90g`} frameBorder={0} allowFullScreen allow="autoplay" />
      </section>
